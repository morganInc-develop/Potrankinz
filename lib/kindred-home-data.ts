...
export const menuItems: MenuItem[] = [
  ...
  // ── Mains ──
  {
    ...
    chefNote: 'Choose at least 1 side, up to 2: one starch and one vegetable.',
  ...
  },
  {
    ...
    chefNote: 'Choose at least 1 side, up to 2: one starch and one vegetable.',
    tags: ['$18', 'Choose up to 2 sides', 'Bright heat'],
  },
  {
  ...
  },
  {
    ...
    title: 'Cabbage Salad',
    price: '$4',
    image: menuImage('jamaican-cabbage-salad.png'),
    category: 'sides',
    ingredients: [
      'Fresh cabbage',
      'Carrot',
    ...
    description:
      'Fresh Jamaican-style cabbage salad with crisp vegetables and bright lime vinaigrette.',
    tags: ['Vegan', 'Side'],
  },
  {
    id: 'pikliz',
    title: 'Pikliz',
    price: '$4',
    image: menuImage('jamaican-pikliz.png'),
    category: 'sides',
    ingredients: [
      'Pickled cabbage',
      'Carrot',
    ...
    description:
      'Spicy Caribbean pickled cabbage slaw with carrots, peppers, Scotch bonnet, vinegar, and lime.',
    tags: ['Vegan', 'Side', 'Spicy'],
  },
  {
    id: 'fried-plantains',
...
export const footer = {
  ...
  contactLines: [
    '7550 Pruitt Research Center Rd',
  ...
  externalLinks: [
    {
      label: 'Google Maps',
      href: 'https://www.google.com/maps/search/?api=1&query=7550%20Pruitt%20Research%20Center%20Rd%2C%20Fort%20Pierce%2C%20FL%2034945',
    },
