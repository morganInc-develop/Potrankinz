  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      >
        ...
        {/* Dark overlay so all content stays legible over the video */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_46%,rgba(0,0,0,0.32),rgba(0,0,0,0.82)_58%,rgba(0,0,0,0.96)_100%)]" />
